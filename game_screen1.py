...
class Ui_gameWindow(object):
    ...
    def setupUi(self, gameWindow):
        ...
        self.three.setGeometry(QtCore.QRect(430, 400, 31, 41))
    ...
    def retranslateUi(self, gameWindow):
        ...
        self.three.setText(_translate("gameWindow", "3"))
        self.two.setText(_translate("gameWindow", "2"))
        self.one.setText(_translate("gameWindow", "1"))
